...
class FormEditRepoOrganisationSecurityPosture(FlaskForm):
    ...
    q50_disaster_recovery_plan = RadioField("50 - Does your practice have an up-to-date documented disaster and recovery plan to ensure that risk and response assumptions and processes are current with respect to the evolving threats?", choices=[('1', 'Yes'), ('2', 'No / Do not know.')], default='1', validators=[DataRequired()])
