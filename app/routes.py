...
def view_repo_vulnerability_info(vulnerability_id):
    if request.method == 'POST':
        ...
        return render_template("view_repo_vulnerability_info.html", repo_vulnerabilities=json_vulnerabilities,
...
def repo_risk_configuration_threat_exposure(threat_id=1, asset_id=-1):
    if request.method == 'POST':
        ...
        print("Threat id is" + str(threat_id))
        return render_template("repo_risk_configuration_threat_exposure.html", threat_id=threat_id, asset_id=asset_id,
...
def repo_risk_configuration_utility_risk(utility_id=1):
    if request.method == 'POST':
        ...
        return render_template("repo_risk_configuration_utlity_risk.html",
...
def view_repo_risk_reports():
    if request.method == 'POST':
        ...
        print(repo_reports)
        new_service_form = FormAddRepoService()
        return render_template("view_repo_reports.html", repo_reports=repo_reports,
                               new_service_form=new_service_form)
